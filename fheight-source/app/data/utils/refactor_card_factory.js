...
(function () {
  ...
  helpers.readFile('./../../sdk/cards/cardFactory.js', (file, contents) => {
    ...
    return helpers.writeFile('./../../sdk/cards/cardFactory.js', contents);
  }).then(() => {
    process.exit(0);
  });
}());
...
let cardFactoryCoffee = fs.readFileSync('cardFactory.js', 'utf8');
...
writeFile('../sdk/cards/cardFactory.js', newCFC);
