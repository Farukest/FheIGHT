...
var QuestsManager = Manager.extend({
      ...
      .then(function () {
        ...
        // on first connect/session start request new daily quests
          this.requestNewDailyQuests().finally(function () {
            ...
            this.dailyQuestsGeneratedAtModel = new FHEIGHTFirebase.Model(null, {
            ...
            // this.dailyChallengesLastCompletedAtModel = new FHEIGHTFirebase.Model(null, {
            //  firebase: dailyChallengesLastCompletedAtModelFirebaseReference
            // })

            this.dailyChallengesLastCompletedAtModel = new FHEIGHTBackbone.Model();
            ...
            this.dailyQuestsCollection = new FHEIGHTFirebase.Collection(null, {
              firebase: dailyquestsFirebaseReference,
            });
  ...
  fetchDailyChallengeModel: function () {
    var dailyChallengeModel = new FHEIGHTFirebase.Model(null, {
