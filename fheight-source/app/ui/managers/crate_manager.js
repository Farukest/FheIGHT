...
var GiftCrateLookup = require('../../sdk/giftCrates/giftCrateLookup.js');
var GiftCrateFactory = require('../../sdk/giftCrates/giftCrateFactory.js');
  ...
  onBeforeConnect: function () {
    ...
    ProfileManager.getInstance().onReady()
      ...
      .then(function () {
        ...
        this._cosmeticChestCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: process.env.FIREBASE_URL + 'user-inventory/' + userId + '/cosmetic-chests',
        });

        this._cosmeticChestKeyCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: process.env.FIREBASE_URL + 'user-inventory/' + userId + '/cosmetic-chest-keys',
        });

        this._giftCrateCollection = new FHEIGHTBackbone.Collection();
