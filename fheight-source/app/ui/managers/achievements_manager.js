  ...
  onBeforeConnect: function () {
    ...
    ProfileManager.getInstance().onReady()
      ...
      .then(function () {
        ...
        this._achievementsStatusModel = new FHEIGHTFirebase.Model(null, {
          firebase: new Firebase(process.env.FIREBASE_URL + '/user-achievements/' + userId + '/status'),
        });

        this._completedAchievementsCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: process.env.FIREBASE_URL + 'user-achievements/' + userId + '/completed',
        });

        this._progressedAchievementsCollection = new FHEIGHTFirebase.Collection(null, {
