...
var ServerStatusManager = Manager.extend({
  ...
  onBeforeConnect: function () {
    ...
    this.serverStatusModel = new FHEIGHTFirebase.Model(null, {
  ...
  requestReloadForGameUpdate: function () {
    var message;
    if (window.isDesktop) {
      message = 'A new version of FHEIGHT has been deployed. Please quit and restart to avoid any issues.';
    } else {
      message = 'A new version of FHEIGHT has been deployed. Please reload to avoid any issues.';
    }
