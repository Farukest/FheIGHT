...
var ChallengeModel = FHEIGHTBackbone.Model.extend({
  ...
  onBeforeConnect: function () {
    ...
    ProfileManager.getInstance().onReady()
      ...
      .then(function () {
        ...
        this.gameCounterRewardsCollection = new FHEIGHTFirebase.Collection(null, {
        ...
        this.gameCounterModel = new FHEIGHTFirebase.Model(null, {
          firebase: new Firebase(process.env.FIREBASE_URL)
            .child('user-progression')
            .child(userId)
            .child('game-counter'),
        ...
        this.bossesDefeatedCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: new Firebase(process.env.FIREBASE_URL)
        ...
        this.bossEventsCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: new Firebase(process.env.FIREBASE_URL)
            .child('boss-events'),
        });
        ...
        _.each(SDK.FactionFactory.getAllPlayableFactions(), function (faction) {
          ...
          var factionProgressionModel = new FHEIGHTFirebase.Model(null, {
            firebase: new Firebase(process.env.FIREBASE_URL)
        ...
        this.challengeProgressionCollection = new FHEIGHTBackbone.Collection();
        ...
        // this.challengeProgressionCollection = new FHEIGHTFirebase.Model(null, {
  ...
  checkForReferralRewards: function () {
    ...
    if (rewardsClaimedAt.isBefore(rewardsUpdatedAt)) {
      ...
      this.listenTo(notification, 'cta_accept', function (model) {
        var model = new FHEIGHTBackbone.Model();
