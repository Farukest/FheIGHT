...
var InventoryManager = Manager.extend({
  ...
  onBeforeConnect: function () {
    ...
    ProfileManager.getInstance().onReady()
      ...
      .then(function () {
        ...
        this.walletModel = new FHEIGHTFirebase.Model(null, {
          firebase: process.env.FIREBASE_URL + 'user-inventory/' + userId + '/wallet',
        });

        this.boosterPacksCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: process.env.FIREBASE_URL + 'user-inventory/' + userId + '/spirit-orbs',
        });

        this.arenaTicketsCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: process.env.FIREBASE_URL + 'user-inventory/' + userId + '/gauntlet-tickets',
        });

        this.riftTicketsCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: process.env.FIREBASE_URL + 'user-inventory/' + userId + '/rift-tickets',
        });

        this.cardsCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: process.env.FIREBASE_URL + 'user-inventory/' + userId + '/card-collection',
        });

        this.cardLoreCollection = new FHEIGHTFirebase.Collection(null, {
        ...
        this.cosmeticsCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: process.env.FIREBASE_URL + 'user-inventory/' + userId + '/cosmetic-inventory',
        });

        this.portraitsCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: process.env.FIREBASE_URL + 'user-inventory/' + userId + '/portraits',
        });

        this.codexChaptersCollection = new FHEIGHTFirebase.Collection(null, {
          firebase: process.env.FIREBASE_URL + 'user-inventory/' + userId + '/codex',
        });

        this.totalOrbCountModel = new FHEIGHTFirebase.Model(null, {
   ...
   * @public
   * @return {FHEIGHTFirebase.Collection} The disechant promos collection
   */
  getDisenchantPromosCollection: function () {
    if (!this._disenchantPromosCollection) {
      this._disenchantPromosCollection = new FHEIGHTFirebase.Collection(null, {
