...
var ProfileLayout = Backbone.Marionette.LayoutView.extend({
  ...
  showSummary: function () {
    if (this.cache.summary) {
      ...
      var currentSeasonLadderPositionModel = new FHEIGHTBackbone.Model();
      ...
      var currentSeasonGameCounterModel = new FHEIGHTBackbone.Model();
  ...
  showRankHistory: function () {
    if (this.cache.rank_history) {
      ...
      //
      var rankHistoryCollection = new FHEIGHTBackbone.Collection();
      rankHistoryCollection.url = this.apiEndpointUrl + '/rank/history';
      rankHistoryCollection.fetch();

      //
      var rankHistoryGameCounters = new FHEIGHTBackbone.Collection();
  ...
  showMatchHistory: function () {
    ...
    if (this.cache['match_history_' + this.gamesHistoryPage]) {
      ...
      //
      var gameHistoryCollection = new FHEIGHTBackbone.Collection();
  ...
  showRiftSummary: function () {
    if (this.cache.rift_summary) {
      ...
      var riftSummaryModel = new FHEIGHTBackbone.Model();
