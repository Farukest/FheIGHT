...
// Enable prototype access for Handlebars 4.6+ compatibility
// This fixes "Access has been denied to resolve the property" errors
// See: https://handlebarsjs.com/api-reference/runtime-options.html#options-to-control-prototype-access
(function() {
  // Monkey-patch the compiled template function wrapper to allow prototype access
  var originalTemplate = Handlebars.template;
  Handlebars.template = function(spec) {
    var template = originalTemplate.call(Handlebars, spec);
    var wrappedTemplate = function(context, options) {
      options = options || {};
      options.allowProtoPropertiesByDefault = true;
      options.allowProtoMethodsByDefault = true;
      return template(context, options);
    };
    wrappedTemplate.partials = template.partials;
