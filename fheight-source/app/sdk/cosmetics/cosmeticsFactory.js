...
cos[CardBack.DawnFHEIGHTs] = {
  id: CardBack.DawnFHEIGHTs,
  typeId: CosmeticsTypeLookup.CardBack, // category of cosmetic
  name: i18next.t("cosmetics.cardback_dawn_of_fheights_name"),
  shopDescription: i18next.t("cosmetics.cardback_dawn_of_fheights_desc"),
  enabled: true,
  alwaysVisible: false,
  order: ORDER_CARD_BACKS,
  rarityId: Rarity.Epic,
  img: RSX.card_back_dawnfheights.img,
  rsx: RSX.card_back_dawnfheights,
  glowOutlineRSX: RSX.card_back_dawnfheights_glow_outline,
  unlockable: true,
  purchasable: false
};
...
cos[ProfileIcon.tournament_dawnoffheights1] = {
  id: ProfileIcon.tournament_dawnoffheights1,
  typeId: CosmeticsTypeLookup.ProfileIcon,
  order: ORDER_PROFILE_ICONS,
  subTypeId: "Neutral",
  enabled: true,
  ...
  rarityId: Rarity.Common,
  alwaysVisible: false,
  img: RSX.portrait_tournament_dawnoffheights1.img,
  rsx: RSX.portrait_tournament_dawnoffheights1,
  unlockable: false,
  purchasable: true
};

cos[ProfileIcon.tournament_dawnoffheights2] = {
  id: ProfileIcon.tournament_dawnoffheights2,
  typeId: CosmeticsTypeLookup.ProfileIcon,
  order: ORDER_PROFILE_ICONS,
  subTypeId: "Neutral",
  enabled: true,
  ...
  rarityId: Rarity.Common,
  alwaysVisible: false,
  img: RSX.portrait_tournament_dawnoffheights2.img,
  rsx: RSX.portrait_tournament_dawnoffheights2,
  unlockable: false,
  purchasable: true
};
