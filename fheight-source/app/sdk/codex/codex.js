...
c[CodexChapters.Chapter1] = {
  ...
  text: [
    ...
    "The vast, temperate continent of Celandine would become the home of the Valorguard Legion. The lush, perilous continent of Xenkai would become the home of the Sharzy Backblade.",
    "The arid, desolate continent of Akram would become the home of the Sandshard Mech. The shattered, broken chasms of Styxus would become the home of the Shadowfell Khalesi.",
    "The primordial, volcanic continent of Magaari would become the home of the Earthmaw Tribe. In the far reaches beyond the Whyte Mountains, Halcyar would become the home of the Frostborne Realm.",
...
c[CodexChapters.Chapter3] = {
  ...
  gamesRequiredToUnlock: 0,
  text: [
    "After the Touch of Eyos, the Earthmaw lived for hundreds of years. They also gained the ability to return to the chrysalis and be reborn anew, making them virtually immortal. Without their Queen Mother, they could not reproduce, but they were not leaderless — over time, a Earthmaw named Valknu became their alpha.",
    "Valknu, as their Prime Focii, discovered a way to save the Earthmaws’ deepest memories as a gift to their future selves. Each cycle required them to re-experience and reinterpret their memories in a process known as the The Dance of Dreams. In order to preserve their memories through time, the Earthmaw developed a magical song-like script that contained their collective experiences in a group consciousness known as The Thirteen Aspects.",
    "Over the millennia, the Earthmaw developed a balanced philosophy of the world, a reflection of their own harmonious path to constant rebirth. They were solitary yet spontaneous, focused on simplicity and the wonders of nature, and detached from personal desires. They mostly kept to themselves, but sometimes travelled great distances to interact with other sentient beings.",
    "Unlike other races, the Earthmaw learned to be still and commune with the Great Tree of Eyos, sometimes spending several kalpas — hundreds of years — to achieve dialogue with it. Thus they learned about the Great Blooming and began to worship and celebrate Eyos as the ultimate bringer of birth, growth, and rebirth.",
...
c[CodexChapters.Chapter6] = {
  ...
  text: [
    ...
    "During this Age of Wonder, the first Aestari Chroniclers explored the mountains beyond their central continent, recording all they discovered. This Age of Wonder also saw the Earthmaw grow into their rightful role as Mythron’s protectors, to meditate, interpret, and guide the Aestari leaders."
  ].join("\n\n")
};
...
c[CodexChapters.Chapter9] = {
  ...
  text: [
    ...
    "The Trial of Champions revealed the finest warriors in all of Aestaria, head and shoulders above all others. Many Aestari distinguished themselves as ‘Frostborne’, or legendary elite. Yet, only a select few displayed the heroic excellence necessary to earn the title of Senerai. They represented the best in each of their respective disciplines. Their unquestioned leader was Songweaver Eurielle. Joining her was Loremaster Lumina, Swordmaster Zwei, Avatar Saari, Arcanyst Graye, and Shieldmaster Koreldyre. But to Kaon’s consternation, they numbered only six.",
    ...
    "She began to question the entire prophecy...until a towering silhouette entered the arena carrying a twin-bladed sword: A Earthmaw.",
    ...
    "Kaon turned to the Frostborne elites and said, “Whoever defeats this Earthmaw shall join the Senerai.”",
    "The Earthmaw was monstrously massive, but when the warriors came at him, he maneuvered with blinding speed and subtle grace. He touched no one but let none touch him. After a full day, as the last Frostborne finally collapsed in exhaustion, Kaon said, “Enough. Starhorn, most honored Earthmaw, you are indeed the Seed of Dreams, the Seventh Star.”"
  ].join("\n\n")
};
...
c[CodexChapters.Chapter13] = {
  ...
  name: "13: The Dawn of the Sandshards",
...
c[CodexChapters.Chapter14] = {
  ...
  text: [
    ...
    "Atar established the Order of Staar and named himself Atar Starstrider. He became rich and influential, but remained a renaissance man and inventor at heart, never obsessed with power or wealth. To make the waterless interior of the continent more habitable, Atar invented the Sand Shield, a mechanized suit of star-powered armor that minimized water loss. Atar coined the term Sandshard — “The Remade Man” — which the people themselves quickly adopted.",
    "Atar continually refined his Sand Shields, making them lighter and stronger. Some were even biologically integrated into the body, all-but eliminating water loss, granting the wearer superhuman abilities and opening new aesthetic possibilities. Water was shared freely with the young, but at adolescence, integration with one’s suit through the solemn Rite of Melding became a civic obligation — and an essential step toward Sandshard adulthood.",
    ...
    "But his most important legacy was that the Sandshards, rather than searching for power solely from the Great Tree, discovered that the true source of power came from the stars themselves."
  ].join("\n\n")
};
...
c[CodexChapters.Chapter15] = {
  ...
  text: [
    ...
    "The Highmayne clan called their newly established home Windcliffe, while those who called themselves the Order of the Second Suns and the Lightchasers established the towering city of Sun Forge on the highest peak in Celandine. In time, the continent became home to the Valorguard Legion.",
    "Another hardy group of Aestari explorers chased similar tales northeast, to the exotic and mysterious continent of Xenkai. They found a harsh and dangerous land of wet jungles, frigid mountains, arid deserts, and ghostly predators at every turn. But they conquered the land, taming and riding many of these creatures, hunting and killing with deadly precision many others. These agile and lethal warriors were the forefathers of the Sharzy Backblade, and founders of the cities of Xaan and Kaido.",
    "Travelling inland, they discovered the Twilight Spring, where dusk and dawn mixed together, blurring light and dark, life and death, blood and earth, animal and human. It was a place where boundaries merged, an aetherial vortex that allowed the Sharzy to commune with their ancestors and spirit essence animals with mystical Twilight Seals, establishing the Ancestral Spirits and Zodiac Masks.",
    "Although they could not transform into the animals themselves — like the Frostborne — they could inherit the abilities and traits of their representative spirit animal. Some Sharzy rulers later came to believe they were the physical descendants of their patron animal, including Kaleos the Ghost Tiger, Gen-Bo the Sable Tortoise, and Taegon the Citrine Dragon.",
...
c[CodexChapters.Chapter17] = {
  ...
  text: [
    ...
    "By the time Emperor Sargos was a young man, Aestaria was already in decline. But Sargos never forgot the prophecy of a greater Second Empire, and he continued to dream of a unified Aestaria whose true greatness lay ahead. Sargos saw the Valorguard, Sandshards, and Sharzy flourishing on the strength of their crystal resources, but he knew the ultimate source of those crystals was the Weeping Tree, which grew on Aestari soil.",
...
c[CodexChapters.Chapter21] = {
  ...
  text: [
    ...
    "Valknu alone put up a heroic fight, but he was ultimately no match for the combined power of Rasha’s forces. Sargos had shared his suspicions that the Earthmaw were hiding something powerful, so Rasha threw Valknu into the palace’s deepest dungeon and tortured him in a futile effort to learn the Earthmaw’s secrets. Though imprisoned, Valknu magically communed with his fellow Earthmaw, warning them of Rasha’s betrayal.",
...
c[CodexChapters.Chapter24] = {
  ...
  text: [
    ...
    "By noon, when Ziros and his Dunecasters finally attacked, half the Aestaris were already dead; the rest driven mad with thirst. But not as mad as their Emperor, who fought on until the lifeblood of his last man drenched the sands and gave mute testimony to the Sandshard’s vengeance. Ziros, still consumed with revenge, had his men build a monument where he fell — Rasha's Tomb — and buried Rasha and his men inside it, cursing them to burn for eternity in the scorching desert heat."
  ].join("\n\n")
};
...
c[CodexChapters.Chapter25] = {
  ...
  text: [
    "'Aestaria will never set foot on Sandshard soil again.' - Ziros Starstrider",
...
c[CodexChapters.Chapter26] = {
  ...
  text: [
    ...
    "Draug’s first move was to establish a secret alliance with the Valorguard’s High Council leaders from Baast, Caerme, Windcliffe, and Lyr, appealing to their resentment of Sandshard primacy and appeasing them with promises of spoils from Vetruvia’s defeat. Only the leaders of Sunforge refused to attend. His northern flank largely secured, he then sent his warships on a surprise attack on the Sharzy capital, Xaan, sinking the unsuspecting Sharzy fleet stationed at port with little difficulty. At the Battle of Three Crossings, General Taegon from Kaido issued desperate pleas for help, but the Valorguard were complicit with Draug, and Ziros remained true to his oath never to aid the Sharzy, who had left the Sandshards to rot in their greatest hour of need. Draug moved past Xaan and conquered Kaido, consolidating his power over the entire continent of Xenkai. The world was shocked, but even as Draug turned his attention to Vetruvia once again, no one would come to the aid of his victims.",
    "Or almost no one..."
  ].join("\n\n")
};
...
c[CodexChapters.Chapter29] = {
  ...
  name: "29: The Second Sandshard Wars",
  ...
  text: [
    ...
    "Draug and his army were unstoppable, sweeping virtually unimpeded over Vetruvia. Ziros nobly sacrificed himself, remaining behind to delay Draug’s forces by activating a blockade of protective Obelysks while what was left of the Sandshard army fled through the plains of El-Gamesh. Draug brought Ziros’ head and shattered Sand Shield back to Aestaria and proclaimed himself Conqueror Draug, ruler of the Eternal Empire, the Second Empire foretold by the Prophecy of Ages. While the other nations kept silent, in awe and in fear, the Valorguard Legion finally took a stand against Draug’s aggression. Alone, they were no match for the Vermillion Army, and in a matter of days both Windcliffe and the longstanding Opaline Gates were toppled by Draug’s superior forces. The Valorguard fell back past the Forbidden Steppes through Agenor’s Pass, where General Trajan from Sunforge took their last stand — but Valorguard itself was no more.",
...
c[CodexChapters.Chapter30] = {
  ...
  text: [
    "The Chakri Avatars welcomed the Khaleem Sisters of Akram, impressed by their innate kindness and their deep drive to help others. The sisters, in turn, were struck by the contemplative peace of the Monastery, and by the incorruptible goodness of the Avatars, who were already aiding large numbers of the Sharzy. Together, they improved the lives of vast numbers of the war-weary.",
...
c[CodexChapters.Chapter33] = {
  ...
  name: "33: Birth of the Shadowfells",
  description: "AE 23,105",
...
c[CodexChapters.Chapter34] = {
  ...
  text: [
    ...
    "As the prophecy foretold, darkness reigned in the form of a protracted war between the ascendant forces of Draug and the Inxikrah. With every indication that the conflict was headed to an inevitable cataclysmic battle, Valknu and the Chakri Avatars took the desperate journey to Deladriss Peake, the secret location of the Great Tree Aperion. Valknu conferred with the Seidir and the Frostborne, ultimately convincing them that the Chakri Avatars were worthy and the situation so dire that they must all be empowered — reborn — through the Blood of Aperion. Only together with Aperion’s power — and only as the First Bloodbound — could they hope to conquer the forces of Draug and the Inxikrah, and pave the way for the true Second Empire."
  ].join("\n\n")
};
...
c[CodexChapters.Chapter40] = {
  ...
  text: [
    ...
    "There were six winners, one each of the Valorguard, Sharzy, Sandshard, Frostborne, and Shadowfell, as well as Vaath, the Earthmaw. They were called the Senerei, in honor of the original Seven Stars selected by Kaon Deladriss’ Trial of Champions. They would be the first to venture inside the Monolith in the sky, the first to see what the great blooming had brought forth. Tens of thousands came to God’s Heel from every continent to watch as the new Senerei, powered only by their own magic, rose into the sky and entered the Monolith."
  ].join("\n\n")
};

c[CodexChapters.Chapter41] = {
  id: CodexChapters.Chapter41,
  name: "41: The Birth of the FHEIGHTs",
