...
/** **************************************************************************
 MainZamatianRiversLayer
 *************************************************************************** */

const MainZamatianRiversLayer = FXCompositeLayer.extend({
  ...
  ctor() {
    ...
    this.whenRequiredResourcesReady().then((requestId) => {
      ...
      // scene elements
      this.bg = BaseSprite.create(RSX.scene_zamatian_rivers_background.img);
      this.lightRay = BaseSprite.create(RSX.zamatian_rivers_light_ray.img);
      this.pillar = BaseSprite.create(RSX.zamatian_rivers_pillar.img);
      this.fg = BaseSprite.create(RSX.zamatian_rivers_cliff.img);
      this.vignette = BaseSprite.create(RSX.zamatian_rivers_vignette.img);
  ...
  getRequiredResources() {
    return FXCompositeLayer.prototype.getRequiredResources.call(this).concat(PKGS.getPkgForIdentifier('ZamatianRivers'));
  },
...
MainZamatianRiversLayer.create = function (layer) {
  return FXCompositeLayer.create(layer || new MainZamatianRiversLayer());
};

module.exports = MainZamatianRiversLayer;
