...
const config = convict({
  ...
  firebase: {
    url: {
      doc: 'Firebase URL, e.g. https://my-fheight-project-12345.firebaseio.com/',
      // format: "url",
      default: '',
      env: 'FIREBASE_URL',
    },
  ...
  aws: {
    ...
    replaysBucketName: {
      default: 'fheight-games', // Invalid bucket, but makes localdev happy.
  ...
  s3_user_backup_snapshots: {
    bucket: {
      ...
      default: 'fheight-user-backup-snapshots',
    },
    key: {
  ...
  postgres_connection_string: {
    ...
    default: 'pg://fheight:fheight@127.0.0.1/fheight',
