...
[here](https://github.com/open-fheight/fheight/releases).
...
Once you see `Fheight 'development' started on port 3000` in the logs, the
...
After you load Fheight in your browser, there are two key places to monitor:
