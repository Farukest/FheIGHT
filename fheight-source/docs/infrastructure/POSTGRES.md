...
```
pg_dump -h localhost -p 5433 -U <your-db-user> -f fheight.sql
```

Enter your password and the dump will begin. When complete, the data will be stored in the `fheight.sql` file locally.
