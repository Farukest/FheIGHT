...
OpenFheight has components in both Google Cloud (Firebase Realtime Database)
...
[here](https://github.com/open-fheight/fheight/blob/main/docs/CONTRIBUTING.md#setting-up-firebase).
...
```
/fheight/staging/firebase/client-email # From serviceAccountKey.json
/fheight/staging/firebase/legacy-token
/fheight/staging/firebase/private-key  # From serviceAccountKey.json
/fheight/staging/postgres/connection-string
/fheight/staging/postgres/password
```
...
firebase_project   = "fheight-12345"
firebase_url       = "https://fheight-12345-default-rtdb.firebaseio.com/"
```
...
[Issues](https://github.com/open-fheight/fheight/issues).
