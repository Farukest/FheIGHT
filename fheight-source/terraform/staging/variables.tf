...
# The S3 bucket name for storing Fheight static assets.
# This name must be globally unique across all of AWS.
variable "assets_bucket_name" {
  type = string
}

# The S3 bucket name for storing Fheight game replays.
# This name must be globally unique across all of AWS.
variable "replays_bucket_name" {
  type = string
}

# The domain name for the staging API service, e.g. play.fheight.com.
variable "staging_domain_name" {
  type = string
}

# The domain name for the CDN, e.g. cdn.fheight.com.
...
# This is not the URL, but the shorthand project name e.g. "fheight-12345".
