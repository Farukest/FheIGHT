...
# example url:
#https://s3-us-west-1.amazonaws.com/fheight-games/staging/170.json

# Resolves to a results object filled with data representing the results of the wipe
retrieve_game_data = (environment,gameId) ->
  return new Promise( (resolve, reject) ->
#    request.get("https://s3-us-west-1.amazonaws.com/fheight-games/staging/170.json").type('application/json').accept('application/json').end (err, res) ->
    request("https://s3-us-west-1.amazonaws.com/fheight-games/"+environment+"/"+gameId+".json", (err, res, body) ->
