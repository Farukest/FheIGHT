...
var FheightFirebase = require('../../../server/lib/fheight_firebase_module.coffee');
...
describe("achievements module", function() {
  ...
  before(function(){
    ...
    .then(function(userIdCreated){
      ...
      return UsersModule.userIdForEmail('unit-test@fheight.local').then(function(userIdExisting){
