...
![Fheight Logo](app/resources/ui/brand_fheight.png)

This is the source code for Fheight, a digital collectible card game and
...
Running Fheight locally requires a free Google Firebase account, software for
...
[Open Issues](https://github.com/open-fheight/fheight/issues/) to see if the
...
OpenFheight is licensed under the Creative Commons Zero v1.0 Universal license.
